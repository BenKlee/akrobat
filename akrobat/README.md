...
├── config
│   ├── akrobat_control.yaml -  config file for ros_gazebo_control
│   └── dynamixel_params.yaml - config file for dynamixel
├── include - folder for all header files of C++ files in src folder
├── launch
│   ├── gazebo.launch - launch file to launch akrobat in gazbeo
│   ├── master.launch - launch file to launch akrobat normally
│   └── include       - folder for launch files used within main launch files
├── msg
